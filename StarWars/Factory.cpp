...
SpaceShip* BomberFactory::create_ship()
{
	...
	string type = "bomber";
	SpaceShip* b_ship = new BomberShip(300, 2, (float)0.2, (float)0.3, type, color, concrete_ship_x, y, angle, r, gun);
	return b_ship;
}
...
SpaceShip* FighterFactory::create_ship()
{
	...
	int concrete_ship_x = x + diff_between_ships * count;
	string type = "fighter";
	SpaceShip* f_ship = new FighterShip(200, 2, (float)0.5, (float)0.1, type, color, concrete_ship_x, y, angle, r, gun);
	return f_ship;
}
...
SpaceShip* CruiserFactory::create_ship()
{
	...
	int concrete_ship_x = x + diff_between_ships * count;
	string type = "cruiser";
	SpaceShip* c_ship = new CruiserShip(250, 2, (float)0.1, (float)0.4, type, color, concrete_ship_x, y, angle, r, gun);
	return c_ship;
}
